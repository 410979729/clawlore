export interface RegexFallbackGovernance {
  state: "pending" | "confirmed";
  confidence: number;
  trust: "degraded" | "normal";
 ...
 */
export function regexFallbackGovernance(degradedReason?: string): RegexFallbackGovernance {
...
export function autoRecallGovernanceEligibility(meta: Record<string, unknown>): {
  eligible: boolean;
  reason?: string;
} {
  if (meta.state !== "confirmed") return { eligible: false, reason: "state_not_confirmed" };
