...
import {
  globalExperienceOperatorDeniedResponse,
  resolveExperienceRuntime,
  safeExperienceToolFailure,
  type ExperienceToolContext
} from "./experience-tool-runtime-policy.js";

export function registerExperiencePromoteTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
...
export function registerForgettingReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerForgettingRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerGovernanceCleanupReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerGovernanceCleanupRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerMemoryCandidatePromotionReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerMemoryCandidatePromotionRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerGraphHygieneReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerGraphHygieneRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerJournalRecoveryReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerJournalRecoveryRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerDigestReportTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerDigestRunTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerDigestRecoveryTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
...
export function registerOperatorDashboardTool(api: OpenClawPluginApi, context: ExperienceToolContext): void {
  api.registerTool((toolCtx) => {
    return {
