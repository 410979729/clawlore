...
export const FORGETTING_REPORT_SCHEMA = {
  ...
  description:
    "Identify stale or low-quality playbooks for cleanup. Finds superseded playbooks (newer version exists) and failing playbooks (high failure rate). Use dry_run first to preview.",
  parameters: {
    type: "object",
    properties: {
      scope: {
