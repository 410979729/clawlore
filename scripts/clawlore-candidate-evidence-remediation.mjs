...
function parseArgs(argv) {
  ...
  for (const required of ["source", "sessions-registry", "baseline-preview", "receipt"]) {
...
const plan = createLiveCandidateEvidenceRemediationPlanV1({
  ...
  baselinePreviewPath: resolve(args["baseline-preview"]),
});
...
process.stdout.write(`${JSON.stringify({
  ...
  candidateRows: plan.source.candidateRows,
  counts: plan.counts,
