...
const { executeLiveSourceLineageReceiptApplyV1 } = jiti(
  "../src/v2/operator/live-source-lineage-receipt-apply.ts",
);
...
function parseArgs(argv) {
  ...
  for (const required of [
    "source", "remediation-preview", "plan", "snapshot-archive", "snapshot-receipt",
...
const receipt = await executeLiveSourceLineageReceiptApplyV1({
