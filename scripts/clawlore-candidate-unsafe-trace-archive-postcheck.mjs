...
const { inspectLiveCandidateUnsafeTraceArchiveV1 } =
...
function parseArgs(argv) {
  ...
  for (const required of ["source", "plan", "apply-receipt", "plan-digest", "receipt"]) {
...
const receipt = inspectLiveCandidateUnsafeTraceArchiveV1({
