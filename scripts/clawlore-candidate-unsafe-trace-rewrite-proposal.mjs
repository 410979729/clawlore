...
const { createLiveCandidateUnsafeTraceRewriteProposalPlanV1 } =
...
function parseArgs(argv) {
  ...
  for (const required of [
    ...
    "rewrite-payload", "rewrite-id", "receipt",
...
const plan = createLiveCandidateUnsafeTraceRewriteProposalPlanV1({
