...
const { createLiveCandidateUnsafeTraceRewritePostcheckV1 } =
...
function parseArgs(argv) {
  ...
  for (const required of [
    "source", "plan", "payload", "proposal-acceptance", "apply-receipt",
...
const receipt = createLiveCandidateUnsafeTraceRewritePostcheckV1({
