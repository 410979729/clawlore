import { isCanonicalPrincipalKey, resolveRuntimeMemoryBoundary, runtimePrincipalIdentity, } from "./runtime-memory-boundary.js";
export const CLAWLORE_PRINCIPAL_SCOPE_CONTRACT = "openclaw-scope-v1";
...
export function resolvePrincipalWriteTarget(input) {
    ...
    if (input.allowConversation === true
