...
import { createVerifiedGenericSqliteSnapshotV2, inspectGenericSqliteSnapshotV2, restoreVerifiedGenericSqliteSnapshotV2, } from "./generic-sqlite-snapshot.js";
...
export async function restoreEncryptedGenericSnapshotArchiveV2(input) {
    ...
    try {
        ...
        const decrypted = await inspectGenericSqliteSnapshotV2(plaintextPath, parsed.header.snapshot.createdAt);
        if (decrypted.sha256 !== parsed.header.snapshot.sha256) {
