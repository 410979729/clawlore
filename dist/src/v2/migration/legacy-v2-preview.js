...
function classify(metadata) {
    ...
    if (source.includes("reflection") || source.includes("summary"))
...
export function previewLegacyMigrationV2(sqlitePath) {
    ...
    try {
        ...
        if (!exists)
            return { schemaVersion: 2, readOnly: true, totalRows: 0, classifications: {}, verificationDebt: 0, invalidMetadataRows: 0 };
