...
import { shouldSkipReflectionMessage, } from "./src/reflection-transcript.js";
...
import { diagnosticContentSummary, diagnosticErrorSummary, diagnosticIdentifier, diagnosticTextSummary, } from "./src/diagnostic-redaction.js";
...
const clawLorePlugin = {
    ...
    register(api) {
        ...
        // Markdown Mirror
        // ========================================================================
        const mdMirror = createMdMirrorWriter(api, config.mdMirror, resolvedDbPath, diagnosticErrorSummary);
        // ========================================================================
        // Register Tools
        // ========================================================================
